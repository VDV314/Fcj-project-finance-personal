...
In this section, you will create an AWS Lambda function that will process expense and budget data from the Finance Tracker application.

## Overview

The Lambda function will:
- Receive requests from API Gateway
- Validate and process expense/budget data
- Perform read/write operations on DynamoDB tables
...
2. Select **Create a new role with basic Lambda permissions**
![Execution Role](/images/5-Workshop/5.4-Lambda/execution-role.png)
### 4. Configure Function URL (Optional)
Enable direct HTTP access to your function:
1. Scroll down to **Additional configurations**
2. Under **Networking** section, check **Enable Function URL**
3. Select **Auth type**: `NONE` (for this workshop)
